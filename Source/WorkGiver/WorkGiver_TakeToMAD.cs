    ...
    public class WorkGiver_TakeToMAD : WorkGiver_Scanner
    {
        ...
        public override bool HasJobOnThing(Pawn pawn, Thing t)
        {
            ...
            if (pawn2 == null || !pawn2.IsPrisonerOfColony || !pawn2.guest.PrisonerIsSecure ||
                pawn2.holdingContainer != null || (pawn2.InMentalState && pawn2.MentalStateDef.IsAggro) ||
        ...
        public override Job JobOnThing(Pawn pawn, Thing t)
        {
            Pawn pawn2 = t as Pawn;
            //if (pawn2 == null || !pawn2.IsPrisonerOfColony || !pawn2.guest.PrisonerIsSecure ||
            //   pawn2.holder != null || (pawn2.InMentalState && pawn2.MentalStateDef.IsAggro) ||
            //   !pawn.CanReserveAndReach(pawn2, PathEndMode.OnCell, pawn.NormalMaxDanger(), 1))
                if (pawn2 == null || !pawn2.IsPrisonerOfColony || !pawn2.guest.PrisonerIsSecure ||
                pawn2.holdingContainer != null || (pawn2.InMentalState && pawn2.MentalStateDef.IsAggro) ||
                !pawn.CanReserveAndReach(pawn2, PathEndMode.OnCell, pawn.NormalMaxDanger(), 1))
            ...
            Building_MAD building_MAD = MadUtility.FindMADFor(pawn2, pawn, true, false, pawn.Map ,false);
            return new Job(DefDatabase<JobDef>.GetNamed("CarryToMAD"), pawn2, building_MAD);

        }
        protected Thing FindMAD(Pawn pawn, Pawn patient)
        {
            return MadUtility.FindMADFor(patient, pawn, patient.HostFaction == pawn.Faction, false, pawn.Map, true);
        }
    }
}